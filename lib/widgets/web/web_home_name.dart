...
class WebHomeName extends StatefulWidget {
  const WebHomeName({super.key});

  @override
  State<WebHomeName> createState() => _HomeNameState();
}

class _HomeNameState extends State<WebHomeName> {
  final key = GlobalKey();
  double? boxHeight;
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      if (mounted && boxHeight == null) {
        ...
        setState(() => boxHeight = box.size.height + 30);
      }
    });
    super.initState();
  }

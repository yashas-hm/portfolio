...
class WebExperienceItem extends StatefulWidget {
  const WebExperienceItem({
    super.key,
  ...
  @override
  State<WebExperienceItem> createState() => _WebExperienceItemState();
}

class _WebExperienceItemState extends State<WebExperienceItem> {
  final key = GlobalKey();
  double? height;
  late double mid;
  late double buffer;

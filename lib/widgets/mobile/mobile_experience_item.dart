...
class MobileExperienceItem extends StatefulWidget {
  ...
  @override
  State<MobileExperienceItem> createState() => _MobileExperienceItemState();
}

class _MobileExperienceItemState extends State<MobileExperienceItem> {
  final key = GlobalKey();
  double? height;

...
class MobileHomeName extends ConsumerStatefulWidget {
  const MobileHomeName({super.key, this.retHeight});

  final Function(double)? retHeight;

  @override
  ConsumerState<MobileHomeName> createState() => _HomeNameState();
}

class _HomeNameState extends ConsumerState<MobileHomeName> {
  final key = GlobalKey();
  double? boxHeight;

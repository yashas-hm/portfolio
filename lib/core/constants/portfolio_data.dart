...
class PortfolioData {
  //INFO: Statics
  static const String aboutBrief =
  ...
  static final List<TestimonialModel> por = [
    TestimonialModel(
      identifier: 'sac',
  ...
  static final List<AchievementModel> techAchievements = [
    AchievementModel(
      identifier: 'sih',
  ...
  static final List<AchievementModel> culAchievements = [
    AchievementModel(
      identifier: 'nirma23',
